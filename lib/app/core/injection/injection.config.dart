...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.factory<_i709.AddOrEditOtherCubit>(
        () => _i709.AddOrEditOtherCubit(gh<_i143.DaleelRepository>()));
    ...
    gh.singleton<_i379.AddOrEditDuaCubit>(
        () => _i379.AddOrEditDuaCubit(gh<_i1008.DuaRepository>()));
