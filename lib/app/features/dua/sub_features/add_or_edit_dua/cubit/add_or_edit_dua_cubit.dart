...
part 'add_or_edit_dua_state.dart';

@singleton
class AddOrEditDuaCubit extends Cubit<AddOrEditDuaState> {
  late TextEditingController textOfDua;
  late TextEditingController duaReward;
  late TextEditingController explanationOfDua;

  AddOrEditDuaCubit(this._duaRepository) : super(const AddOrEditDuaState()) {
